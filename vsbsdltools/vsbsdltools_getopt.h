...
typedef struct vsbsdltools_option vsbsdltools_option_t;

struct vsbsdltools_option
{
...
void vsbsdltools_getopt_wrapped_fprint(
      FILE *stream,
...
void vsbsdltools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vsbsdltools_option_t *options,
      int number_of_options );

int vsbsdltools_getopt_get_options_string(
     const vsbsdltools_option_t *options,
     int number_of_options,
